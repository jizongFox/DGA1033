...
class ADMM_networks(object):
    ...
    '''
    def __init__(self, neural_network,lr, lamda=1, sigma=0.02, kernelsize=5, assign_size_to_each=False,eps=0.1,**kwargs):
...
class weakly_ADMM_network(ADMM_networks):
    ...
    def __init__(self, neural_network, lr, lamda=1, sigma=0.02, kernelsize=5,dilation_level = 7,assign_size_to_each=False,eps=0.1,**kwargs):
...
class weakly_ADMM_without_sizeConstraint(weakly_ADMM_network):
    ...
    def __init__(self, neural_network,lr, lamda=1.0, sigma=0.02, kernelsize=5,dilation_level=7):
        super().__init__(neural_network, lr,lamda=lamda, sigma=sigma, kernelsize=kernelsize,dilation_level=dilation_level)
...
class weakly_ADMM_without_gc(weakly_ADMM_network):
    ...
    def __init__(self,neural_network,lr ,assign_size_to_each=False,eps=0.1):
        super().__init__(neural_network,lr, lamda=1, sigma=1, kernelsize=5,assign_size_to_each=assign_size_to_each,eps=eps)
