...
def build_dataloader(train_set, val_set, num_workers, batch_size, shuffle=False, group_train=False):
    ...
    if group_train:
        ...
        train_loader = DataLoader(train_set, num_workers=num_workers, batch_size=1, batch_sampler=tra_sampler)

    val_loader = DataLoader(val_set, num_workers=num_workers, batch_sampler=val_sampler, batch_size=1)
