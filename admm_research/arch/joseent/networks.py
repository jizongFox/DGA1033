...
from admm_research.arch.joseent.layers import conv_block, conv_block_3, maxpool, conv_decod_block
...
class Dummy(nn.Module):
    def __init__(self, in_dim: int, out_dim: int, dtype=torch.float32) -> None:
        super().__init__()
