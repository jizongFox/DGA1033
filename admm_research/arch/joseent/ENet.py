...
from admm_research.arch.joseent.layers import upSampleConv, conv_block_1, conv_block_3_3, conv_block_Asym
...
class ENet(nn.Module):
    def __init__(self, nin=1, num_classes=2):
        ...
        self.out_025 = nn.Conv2d(self.nKermelsInit * 8, num_classes, kernel_size=3, stride=1, padding=1)
        self.out_05 = nn.Conv2d(self.nKermelsInit, num_classes, kernel_size=3, stride=1, padding=1)
        self.final = nn.Conv2d(self.nKermelsInit, num_classes, kernel_size=1)
