...
python train.py --device=cuda  --dataroot=cardiac --method=admm_size --data_aug=False --arch=enet --max_epoch=80 --save_dir=results/cardiac/size_enet_0.4 --eps=0.1 &
...
python train.py --device=cuda  --dataroot=cardiac --method=admm_size --data_aug=False --arch=enet --max_epoch=80 --save_dir=results/cardiac/size_enet_0.4 --eps=0.2 &
