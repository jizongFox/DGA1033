...
OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES=1 python train.py --device=cuda --dataroot=cardiac --optim_inner_loop_num=3 --stop_dilation_epoch=200 --ignore_negative=False --eps=0.1 &
